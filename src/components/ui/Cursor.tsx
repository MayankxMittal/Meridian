...
const MetaBalls: React.FC<MetaBallsProps> = ({
  ...
  useEffect(() => {
    ...
    function onPointerMove(e: PointerEvent) {
      ...
      // The container is intentionally pointer-events-none so it never blocks
      // the page. A window move is therefore the reliable signal that the
      // cursor ball should follow the pointer.
      pointerInside = true;
    ...
    // Listen on window so the visual overlay can remain pointer-events-none and
    // never block buttons, inputs, or links beneath it.
